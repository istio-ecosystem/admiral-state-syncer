module github.com/istio-ecosystem/admiral-state-syncer
...
require (
	...
	github.com/istio-ecosystem/admiral v0.0.0-20240607224503-74cd14071a39
...
require (
	...
	istio.io/api v0.0.0-20220621155648-3e39d064ab6b // indirect
